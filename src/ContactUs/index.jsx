...
//         </motion.div> */}
//         <motion.div
//           className="address-container flex flex-col items-center justify-center w-[90%] max-w-[400px] px-6 py-4 rounded-lg backdrop-blur-lg bg-white/10 border border-white/30"
//           initial="hidden"
//           animate="visible"
//           variants={fadeIn}
//         >
//           {/* Stamp Image */}
//           <motion.div className="address-stamp-container flex justify-center">
//             <img
//               src={Stamp}
//               alt="Stamp"
//               className="address-stamp w-16 md:w-20"
//             />
//           </motion.div>
...
//             animate="visible"
//             variants={fadeIn}
//             className="address-content flex flex-col items-center text-gray-300 space-y-2 text-center"
//           >
//             <h3 className="text-lg md:text-2xl font-extrabold text-white tracking-wide uppercase">
//               USA Office
//             </h3>
      ...
      <div className="main-banner">
        ...
        >
          ...
          <motion.div className="address-content">
            ...
            <p>
              <strong className="
              text-blue-400">Address</strong><br /> 3080 Olcott Street, Unit BBU245 Santa Clara, CA - 95054
            </p>
            <p>
              <strong className="
              text-blue-400
              ">Email</strong><br /> info@amtexenterprises.com
            </p>
            <p>
              <strong className="
              text-blue-400
              ">Phone</strong><br /> +1 (408) 734-4050
            </p>
          </motion.div>
        </motion.div>
      </div>
